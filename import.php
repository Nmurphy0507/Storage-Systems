...
<div class="topnavbar">
    ...
    <li class="dropdown">
            <a href="javascript:void(0)" class="dropbtn btn btn-dark mx-2 mt-2 mb-2 dropdown-toggle">Keys </a>
            <div class="dropdown-content">
                ...
                <a href="ArchivedKeys.php">Archived Keys</a>
            </div>
        </li>
        <li class="dropdown">
        <a href="javascript:void(0)" class="dropbtn btn btn-dark mx-2 mt-2 mb-2 dropdown-toggle">Building </a>
        <div class="dropdown-content">
        ...
        <li class="dropdown">
        <a href="javascript:void(0)" class="dropbtn btn btn-dark mx-2 mt-2 mb-2 dropdown-toggle">Wooten </a>
            <div class="dropdown-content">
        ...
        <li class="dropdown">
        <a href="javascript:void(0)" class="dropbtn btn btn-dark mx-2 mt-2 mb-2 dropdown-toggle">FSY </a>
            <div class="dropdown-content">
                <a href="homepage.php?group=FSY Week 1">FSY Week 1</a>
                <a href="homepage.php?group=FSY Week 1">FSY Week 2</a>
                <a href="homepage.php?group=FSY Week 1">FSY Week 3</a>
            </div>
        </li>
     
        <li style="float:right"><a href="add_new.php" class="btn btn-dark mx-2 mt-2 mb-2"> Add New </a></li>
        <li style="float:right"><a href="import.php" class="btn btn-dark mx-2 mt-2 mb-2"> Insert Dataset </a></li>

        <form class="p-2" method="get">
...
<div class="column middle my-4 mx-5">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <buton class="btn btn-primary mt-3"> Import xlsx file</buton>
                </form>
            </div>
        </div>
    ...
    <div class="card-body">
        ...
        <form id="table-form" method="POST" onsubmit="return validateForm()">
            ...
            <div style="display: flex; justify-content: flex-end;"> <button type="button" id="add-row" class="btn btn-success mx-3">Add Row</button></div>
            <div style="justify: text-center:"><button type="submit" class="btn btn-primary" name="submit">Save All To Database</button></div>
        </form>
    </div>
</div>
</div>
